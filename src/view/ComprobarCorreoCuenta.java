 ...
 */
public class ComprobarCorreoCuenta extends javax.swing.JFrame {

    /**
     * Creates new form Login
     */
    public ComprobarCorreoCuenta() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComprobarCorreoCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComprobarCorreoCuenta().setVisible(true);
            }
        });
    }
